...
export function OnboardingChecklist({ onboarding }: { onboarding: ContentStudioOnboarding }) {
  ...
  return <section className="card onboarding-checklist" aria-labelledby="setup-checklist-title">
    <div className="onboarding-checklist-head"><ClipboardCheck size={21} /><div><span>SETUP CHECKLIST</span><h2 id="setup-checklist-title">Finish setting up Content Studio</h2><p>{onboarding.completed_steps.length} of 4 steps complete</p></div><Link className="li-quiet-button" to="/content/onboarding">Continue setup</Link></div>
