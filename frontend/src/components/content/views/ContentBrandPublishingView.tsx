...
export function ContentBrandPublishingView() {
  ...
  return (
    <section className="li-settings-page" aria-label="Brand and Publishing">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px', marginBottom: '24px', borderBottom: '1px solid #e5e7eb', paddingBottom: '16px' }}>
        <div>
          <h2 style={{ margin: 0 }}>Brand &amp; Publishing</h2>
          <p style={{ margin: '4px 0 0', color: '#64748b' }}>Keep your brand guidance, publishing schedule, and approval workflow together.</p>
        </div>
